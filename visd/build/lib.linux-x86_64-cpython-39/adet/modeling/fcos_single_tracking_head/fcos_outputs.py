...
class FCOSOutputs(nn.Module):
    ...
    def losses(self, logits_pred, reg_pred, ctrness_pred, offset_pred, locations, gt_instances, top_feats=None, top_feats2=None, top_feats3=None):
        """
    ...
    def predict_proposals(
            ...
            locations, image_sizes, top_feats=None, top_feats2=None, top_feats3=None
    ):
        if self.training:
        ...
        for i, per_bundle in enumerate(zip(*bundle.values())):
            ...
            sampled_boxes.append(
                self.forward_for_single_feature_map(
                    l, o, r, c,offset, image_sizes, t, t2, t3
                )
            )
    ...
    def forward_for_single_feature_map(
            ...
            ctrness_pred, offset_pred, image_sizes, top_feat=None ,top_feat2 = None, top_feat3 = None
    ):
